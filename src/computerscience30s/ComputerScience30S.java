...
//        
//        // Dialogs for inputs
//        // The simplest version is the one you have to know
//        
...
//                JOptionPane.PLAIN_MESSAGE);
        ...
        // The simpplest variable (variables store "remember" data"
...
//         c=1.2;
//         
//         //variables always go on the lefthand side (LHS) or the equals
...
//                 
//         //the boolean, the int, double, char are all simple
//         //data types (primitave), now a complex type...
//         
//         String e = "monkey";
...
//        
//        //Contants are variables that don't change, and 
...
//        // "Casting" means ut ignores the decimal part
//       
//        int h = (int) g;
//        System.out.println("g =" + g);
...
//        double m = (double)l;
//        
//        //casting can happen with other tyoes
//        
//        char n = 'A';
//        int o = (int)n;
//        char p = (char)70;
...
//        //and then convert it to a number (ike...
...
//    
//        
//        //The nexttype of loop is rarely used (you may never need it)
...
// (7) The world "null" means nothing and can act as a placeholder for code
//     That you don't actually need (for now)
